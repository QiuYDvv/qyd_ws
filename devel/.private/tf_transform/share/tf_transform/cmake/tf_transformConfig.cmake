...
if("TRUE" STREQUAL "TRUE")
  set(tf_transform_SOURCE_PREFIX /home/qyd/dx/one_ws/src/tf_transform)
  set(tf_transform_DEVEL_PREFIX /home/qyd/dx/one_ws/devel/.private/tf_transform)
  ...
  set(tf_transform_INSTALL_PREFIX /home/qyd/dx/one_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf_transform' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qyd/dx/one_ws/src/tf_transform/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/qyd/dx/one_ws/devel/.private/tf_transform/lib;/home/qyd/dx/one_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "geometry_msgs;roscpp;std_msgs;tf2;tf2_geometry_msgs;tf2_ros;tf2_sensor_msgs")
